...
import { Share2, Copy, EllipsisVertical, ChevronDown, Trash2, FilePenLine, CircleAlert, SquareMinus, MailPlus, Plus } from "lucide-react";
          ...
          <div className="mt-4 bg-white rounded-lg p-3">
            <div className="flex justify-between items-center">
              <div className="flex gap-2">
                ...
                <div>
                  <strong>T-Systems Tech Day</strong>
